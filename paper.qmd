...
Thus, computationally efficient methods to assess and continuously revalidate the collision risk of uncontrolled re-entries and aircraft will help to fine-tune the decision-making and geospatial and temporal constraints on aviation.
...
* $W_H(h)$ is the median value of the weighting function over the area of hexagon
$h$,
