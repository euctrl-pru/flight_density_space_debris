...
race to commercialise space call for a re-evaluation of the risk of
...
region.
Apart from the general risk assessment of potential re-entries, we analyse
a soon to occur re-entry of debris from a 1972 failed USSR mission to Venus.
...
If we discretaze the area of interest $a$ using H3 cells,
we have
...
a rectangular solid with dimesions of wingspan, length and height. 
