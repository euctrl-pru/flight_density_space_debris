...
[^adsb]: Crowdsourced ADS-B/Mode S data suffer from lack of coverage away from landmasses and from the need to filter away position reports for stationary aircraft at airports which unnecessarily inflate the density of flying traffic.

This work focusses on the European region. The hourly flight density
estimation is based on flown \acr{IFR} trajectories as recorded by
