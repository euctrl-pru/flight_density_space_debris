...
In the derivation of debris orbital positions, we use the value of the mass of Earth, $M_{\oplus} = \qty{5.9722e24}{kg}$ but we neglect that of the debris
because many orders of magnitudes smaller (and not always known).
