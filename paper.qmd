...
#| out-width: "45%"
#| echo: false
knitr::include_graphics(here::here("media", "figures", "cell_london.png"))
```

Cell with highest collision expectation due to KOSMO debris re-entry based on 2024-07-05 traffic.
:::
...
the cell with the highest impact risk is cell, `83194afffffffff` (located South
of London, cf. @fig-kosmos-cell), with a value of $1.89 \cdot  10^{-10}$.
...
Code and sample data is available in the companion GitHub repository of
...
::: {#fig-orbital-elements layout="[40,-4,56]" fig-env="figure*" fig-pos="htb"}
